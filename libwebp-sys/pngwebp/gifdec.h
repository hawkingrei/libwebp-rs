...
int readGifBuffer (struct GifFileType* gf, GifByteType* buf, int length );
void PWebPDataInit(struct WebPData* webp_data);
void PWebPDataClear(struct WebPData* webp_data);
